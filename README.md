...
| Stakeholders and Interests | Loan Analyst: Wants to enter and save details of the loan, including financial, categorical, contact, and description details<br><br>Loan Accountant: Wants the details to be entered and saved accurately, as the accountant will be responsible for generating journal entries based the information<br><br>Billing Analyst: Wants information to be entered and saved accurately, as invoices will be generated using this information<br><br>Treasury Analyst: Wants information to be entered and saved accurately, as they need to reconcile and forecast cash activity generated by this information<br><br>Credit Officers: Want information to be entered and saved accurately, as they need to use this information as a starting point for credit analysis<br><br>Corporate Accounting System: Wants to interface with the System to receive accounting information partially based on this input<br><br>Reporting System: Wants to interface with the System to generate reports and analytics based on this input<br><br>Email System: Wants to interface with the System to send invoices to Customers based on this input<br><br>Loan Closing Team: Wants information to be entered and saved accurately, since their performance and compensation will be partially measured by this information<br><br>Customers: Want information to be entered and saved accurately, since they will be billed based on this information<br><br>Corporate Accounting Team: Wants information to be entered and saved accurately, since it will ultimately feed financial statements (via the Corporate Accounting System) and because they are ultimately responsible for reporting correct financial information<br><br>Management: Wants information to be entered and saved accurately, as they run the Company and the records represent the results of the Company’s core product offering. They are also judged on financial information, which is partially based on this input<br><br>External Auditors: Want information to be entered and saved accurately, as this information will be used to produce financial statements, which the auditors are required to opine on<br><br>Financial Regulators: Want information to be entered and saved accurately, as this information will be used to produce financial information that will affect both investors and Customers. |
...
| Stakeholders and Interests | Corporate Accounting System: Wants to interface with the System to receive information generated as a result of this step.<br><br>Corporate Accounting Team: Wants this information and its transfer into the Corporate Accounting System to be timely and accurate, as they are responsible for closing the books and producing the financial statements based on this data.<br><br>Management: Wants this information and its transfer into the accounting system to be accurate, as they utilize and are judged by the information in the financial statements and Corporate Accounting System.<br><br>External Auditors: Want information and its transfer to be accurate, as they are responsible for auditing the System, the Corporate Accounting System, the transfer process, and the Financial Statements.<br><br>Financial Regulators: Want information to be accurate, as it is used to produce financial statements and other information that investors utilize and rely on to make investing decisions. |
